...
typedef struct {
    ...
    union {
        ...
        struct {
            ...
            uchar wlog;
            union {uchar hlog,loop;} noname2;
        } noname3;
    } noname4;
    fix w;
    /* edge data */
    union {grs_tmap_edge left,top;} noname5;
    union {grs_tmap_edge right,bot;} noname6;
    fix dw;
    ulong u_mask;
    union {ulong v_mask,mask;} noname7;
    ...
    union {void (*left_edge_func)(), (*top_edge_func)();} noname8;
    union {void (*right_edge_func)(),(*bot_edge_func)();} noname9;
} grs_tmap_loop_info;
