...
typedef struct {
    ...
    union {uchar *clut; long fill_parm;} noname1;
    fix scan_slope;
    int dp;
    fix alpha_u;
    fix beta_u;
...
typedef struct {
    uchar *p_dst_final;
    int p_dst_off;
    union {fix y_fix,x_fix;} noname1;
    fix u,du,v,dv,i,di;
    fix u0,v0;
    union {uchar *clut; long fill_parm;} noname2;
    fix unum,vnum,dunum,dvnum,denom;
    fix dxl,dyl,dtl,dxr,dyr,dtr;
    fix cl,cr;
    fix scan_slope;
    int dp;
    union {int yp,xp;} noname3;
    union {int x,y;} noname4;
    union {int xl,yl;} noname5;
    union {int xr,yr;} noname6;
    union {int xr0,yr0;} noname7;
